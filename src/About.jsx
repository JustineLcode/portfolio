...
import './styles.scss'
import './_about.scss'; /* Pour importer les fichiers Sass!! */
...
I am now fully committed to developing my skills and bringing the same dedication, precision, and adaptability that I demonstrated in my previous roles to this new field.</p>
            </div>
        </div>
